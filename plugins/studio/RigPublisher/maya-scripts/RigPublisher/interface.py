...
# itself moved out of this window on 2026-07-19 too, into RigPublisher's
# own Repo Studio Setting tab in UkoreHub (settings_page.py) — this window
# has no custom-path input of its own anymore, only a Ticket to pick.
# ================================================
...
from RigPublisher import function
