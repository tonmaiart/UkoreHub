...
class CustomShifterStep(cstp.customShifterMainStep):
    ...
    def run(self):
        ...
        dict_enum_space = {"arm_L0_root_fk_ctl":["arm_L0_root_fk_ctl",["master_C0_ctl","torso_C0_spine5_jnt", "torso_C0_cog_ctl","world_ctl","clavicle_L0_ctl"],["Master","Chest", "Cog","World","Clavicle"],"orient"],
                           "arm_L0_wrist_ik_ctl": ["arm_L0_wrist_ik_ctl", ["master_C0_ctl","torso_C0_cog_ctl","torso_C0_spine5_jnt","world_ctl"],["Master","Cog", "Chest","World"], "parent"],
                           "leg_L0_root_fk_ctl": ["leg_L0_root_fk_ctl", ["master_C0_ctl","torso_C0_cog_ctl","world_ctl" ],
                                                  ["Master","Cog","World", ], "orient"],
                           "leg_L0_wrist_ik_ctl": ["leg_L0_wrist_ik_ctl", ["master_C0_ctl","torso_C0_cog_ctl","world_ctl" ],
