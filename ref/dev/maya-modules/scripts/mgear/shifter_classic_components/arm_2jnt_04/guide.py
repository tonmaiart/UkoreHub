...
NAME = "arm"
DESCRIPTION = (
    "Elbow thickness control.New Up Vector roll control. 2 bones arm with Maya"
    " nodes for roll bones. With elbow Pin. Wrist alignment option."
)
...
class Guide(guide.ComponentGuide):
    ...
    def addParameters(self):
        ...
        self.pElbowThickness = self.addParam(
            "elbowThickness", "double", 0, 0, 1)
