...
class Component(component.Main):
    ...
    def addObjects(self):
        ...
        o_set = self.settings
        self.divisions = o_set["div0"] + o_set["div1"] + o_set["div2"] + 3
        ...
        jdn_femur = jd_names[0]
        jdn_tibia = jd_names[1]
        jdn_cannon = jd_names[2]
        jdn_femur_twist = jd_names[3]
        jdn_tibia_twist = jd_names[4]
