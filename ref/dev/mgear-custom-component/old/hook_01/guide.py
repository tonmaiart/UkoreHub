...
TYPE = "hook_01"
NAME = "hook"
DESCRIPTION = "Simple controller with space switch and Rot order selection. \n"\
              ...
              "This is a variation of control_01 to just be a rig hook with no animator interface."
