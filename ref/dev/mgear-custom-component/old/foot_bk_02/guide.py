...
# guide info
AUTHOR = "Jeremie Passerin, Miquel Campos, Chris Lesage"
URL = "www.jeremiepasserin.com, www.miquel-campos.com, chrislesage.com"
EMAIL = "geerem@hotmail.com, hello@miquel-campos.com, chris@chrislesage.com"
VERSION = [1, 0, 0]
TYPE = "foot_bk_02"
NAME = "foot"
DESCRIPTION = "Foot with reversed controllers to control foot roll. \
        This version has a slight modification so that the IK rolls are world-oriented. \
        In the original foot_bk_01, they get their ORI from the locator placements. \
        This assumption breaks on feet that are not perfectly flat on the ground. \
        Based off of foot_bk_01."
