...
from TonmaiToolkit.core import Utility,Misc,Connection,BlendShape,Transform
            ...
            def create_extra_loop():
                ...
                for loop_count in range(self.extra_loop_amount):
                    ...
                    for i,name in enumerate(list_name):
                        ...
                        # snap position
                        Transform.transform_to_between_object(list_joint_rim[i], list_corner_guide[i], locator, percentage=loop_count * self.loop_blend_factor)
        ...
        def create_extra_loop():
            ...
            for loop_count in range(1,self.extra_loop_amount-1):
                for i,name in enumerate(self.dict_extra[loop_count]["upper_name"]+self.dict_extra[loop_count]["lower_name"]):
                    ...
                    u,v = Transform.get_nearest_nurbs_curve_parameter(curve=self.nurbs_plane_loop,object=loc_aim,typ="surface")
