...
class Guide(guide.ComponentGuide):
    ...
    def postInit(self):
        ...
        self.save_transform = ["root","lipsMover","bigScale","controller","jaw","inner"]
    ...
    def addObjects(self):
        ...
        self.addLoc(name="lipsMover",parent=self.root,position=(0,0,0.5),color=9)
