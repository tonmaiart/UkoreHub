...
VERSION = "1.0.0"
TYPE = "es_leg_01"  # this name must match with your component folder ,
NAME = "leg"  # and Do not have any syntax.
DESCRIPTION = "Leg Rig, without foot rig."
...
class Guide(guide.ComponentGuide):
    ...
    def addObjects(self):
        ...
        self.loc_elbow = self.addLoc(
            name="low", parent=self.root, position=[0, -3, 0.1]
        )
        self.loc_wrist = self.addLoc(
            name="end", parent=self.loc_elbow, position=[0, -6, 0]
        )
        self.loc_eff = self.addLoc(
            name="eff", parent=self.loc_wrist, position=[0, -6, 0.5]
        )
