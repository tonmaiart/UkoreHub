...
def publish_playblast():
    ...
    current_folder = os.path.basename(os.path.dirname(current_file))

    export_dir_path = os.path.join(current_project, "movies", current_folder)
    export_file_path = os.path.join(export_dir_path, os.path.basename(current_file))
