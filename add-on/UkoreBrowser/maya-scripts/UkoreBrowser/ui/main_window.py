...
# The package root — .../add-on/UkoreBrowser/maya-scripts/UkoreBrowser — no
# matter which submodule this file lives under, so template/ and ui.ui keep
# resolving correctly regardless of nesting depth.
