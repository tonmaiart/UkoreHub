...
VERSION = "1.0.0"
TYPE = "es_neck_01"
NAME = "neck" #this name must match with your component folder , and Do not have any syntax.
...
class Guide(guide.ComponentGuide):
    ...
    def postInit(self):
        ...
        self.save_transform = ["root","head"]

    def addObjects(self):
        """Add the Guide Root, blade and locators"""

        self.root = self.addRoot()
        self.head = self.addLoc("head",self.root,(0,2,0))

        self.addDispCurve(name="neckCrv",centers=[self.root,self.head])
