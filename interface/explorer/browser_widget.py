...
from interface.explorer.file_table_proxy import FileTableFilterProxy
from interface.explorer.path_commit_history_panel import PathCommitHistoryPanel

COLUMN_COUNT = 5
OPENING_POPUP_DURATION_MS = 3000

_ICONS_DIR = Path(__file__).resolve().parent.parent.parent / "data" / "icons"
# Not present in data/icons/ yet — falls back to text (same convention as
# interface/sidebar/sidebar.py's Setting button) until these are added.
BACK_ICON_PATH = _ICONS_DIR / "icons8-back-50.png"
UP_ICON_PATH = _ICONS_DIR / "icons8-up-50.png"
